...
struct MachinesPanelView: View {
    ...
    @State private var fallbackSelectionStore = CloudTreeSelectionStore()
    ...
    private var machinesList: some View {
        ...
        return CloudTreeOutlineView(
            ...
            selectionStore: AppDelegate.shared?.cloudTreeSelectionStore(for: tabManager) ?? fallbackSelectionStore,
